...
import { keccak256Hex } from "../crypto/index"
...
import type { JsonFragment } from "./fragments";
    ...
    #getFunction(key: string, values: null | Array<any | Typed>, forceUnique: boolean): null | FunctionFragment {
        ...
        if (key.indexOf("(") === -1) {
            ...
            if (matching.length === 1 && values && values.length !== matching[0].inputs.length) {
                ...
                if (lastArg === undefined || lastArg === null || Array.isArray(lastArg) || typeof(lastArg) !== "object") {
                    matching.splice(0, 1);
                }
            }
...
*/
    ...
    encodeFilterTopics(fragment: EventFragment | string, values: ReadonlyArray<any>): Array<null | string | Array<string>> {
        ...
        const encodeTopic = (param: ParamType, value: any): string => {
            if (param.type === "string") {
                ...
                return keccak256Hex(hexlify(value));
            }
        ...
        values.forEach((value, index) => {
            ...
            if (!param.indexed) {
                assertArgument(value === null || value === undefined,
        ...
        fragment.inputs.forEach((param, index) => {
            ...
            if (param.indexed) {
                if (param.type === "string") {
                    ...
                    topics.push(keccak256Hex(value))
    ...
    decodeEventLog(fragment: EventFragment | string, data: BytesLike, topics?: ReadonlyArray<string>): Result {
        ...
        const resultIndexed = topics ? this.#abiCoder.decode(indexed, concat(topics)): null;
    ...
    parseTransaction(tx: { data: string, value?: BigNumberish }): null | TransactionDescription {
        ...
        const value = getBigInt((tx.value !== null && tx.value !== undefined) ? tx.value: 0, "tx.value");
